...
| Registrierter Benutzer | meine gesammelten Punkte einlösen können    | einen Rabatt beim mieten eines privaten Parkplatzes bekomme  | Der Benutzer kann gesammelte Punkte gegen einen Rabatt einlösen   |
...
| Funktion / Relevanz                                                                                 | Name                 | Kontakt / Verfügbarkeit       | GitHub-Account |
| --------------------------------------------------------------------------------------------------- | -------------------- | ----------------------------- | -------------- |
| Product Owner, Teamleiter, DevOps-Engineer, Backend-Entwickler, Frontend-Entwickler, IOS-Entwickler | Timo Haverich        | timo.haverich@hsbi.de         | HauerichT      |
| Product Owner, UX/UI Designer, Frontend-Entwickler, Android-Entwickler                              | Marvin Petschulat    | marvin.petschulat@hsbi.de     | MVBeats        |
| Product Owner, Frontend-Entwickler, DevOps-Engineer, Tester, Code-Reviewer                          | Edwin Dik            | edwin.dik@hsbi.de             | Minerder       |
| Product Owner, Frontend-Entwickler, Tester, Code-Reviewer                                           | Bent Schöne          | bent.schoene@hsbi.de          | Scepzz         |
| Product Owner, Frontend-Entwickler, Android-Entwickler                                              | Mattis Wellenbüscher | mattis.wellenbuescher@hsbi.de | Venneqz        |
| Product Owner, Frontend-Entwickler, IOS-Entwickler                                                  | Tim Röckemann        | tim.roeckemann@hsbi.de        | Tim-Roeckemann |
| Product Owner, Frontend-Entwickler, Android-Entwickler                                              | Jan-Ole Löffler      | jan-ole_timo.loeffler@hsbi.de | Loeffler13     |
